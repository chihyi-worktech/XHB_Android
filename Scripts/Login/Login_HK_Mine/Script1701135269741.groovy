...
'輸入帳號'
Mobile.setText(findTestObject('Object Repository/Login/MT4Account'), GlobalVariable.HKAccount, 0)

'輸入密碼'
Mobile.setText(findTestObject('Object Repository/Login/password'), GlobalVariable.HKPassword, 0)
